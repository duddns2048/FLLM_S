...
from gemma import GEMMATransformer
import time
...
class VisionTransformerInput(nn.Module):
    def __init__(self, image_size, patch_size, in_channels, embed_size):
        ...
        self.llm_dim_mapper1 = nn.Linear(embed_size, 3072, bias=False)
        self.llm_dim_mapper2 = nn.Linear(3072, embed_size, bias=False)
...
# python VIT_GEMMA.py --data_dir /path/to/data --data_file /path/to/data_file.txt --image_size 128,128,128 --patch_size 16,16,16 --epochs 100 --batch_size 4 --lr 3e-4 --task_name 'Task01_BrainTumour'